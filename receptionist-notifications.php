...
role('receptionist');
    ...
    $queryPerson = "select * from notifications where receiver not in(SELECT patientid from patient) order by id desc";
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="receptionist-notifications.php">Notifications</a>
                    </li>
                </ol>
                <div class="row">
                    <div class="col-12">
