...
role('patient');
    ...
    $get_docid = mysqli_fetch_array ( mysqli_query ( $conn, "Select patientid from patient where email='".$_SESSION['email']."'" ) );
    $docid = $get_docid ["patientid"];
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="patient-notifications.php">Notifications</a>
                    </li>
                </ol>
                <div class="row">
                    <div class="col-12">
